...
const classInventory = require('../../class/products') 
...
router.get('/loadAllProducts/:organization_id', async (req, res) => { 
  let token = req.headers.authorization
    let verify = verifyCookies(token)
    if (typeof verify === 'object') {
        let data = await classInventory.loadAllProducts( req.params.organization_id)
